...
public class DatePickerFragment2 extends DialogFragment
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        Toast.makeText(getActivity(), "End Date "+day+ "-" +month +"-" + year,Toast.LENGTH_LONG).show();
        filterFrag.end_flag =  filterFrag.getDay(day);
       // Toast.makeText(getActivity(),String.valueOf(filterFrag.end_flag) ,Toast.LENGTH_LONG).show();
    }
}